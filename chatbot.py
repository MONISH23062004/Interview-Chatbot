...
if not st.session_state.setup_complete:
    ...
    with col2:
        st.session_state["position"] = st.selectbox(
            "Choose a position",
            ("Data Scientist", "Data Engineer", "ML Engineer", "BI Analyst", "Financial Analyst","Software Engineer","Frontend-Developer","Backend-Developer"),
            index=("Data Scientist", "Data Engineer", "ML Engineer", "BI Analyst", "Financial Analyst","Software Engineer","Frontend-Developer","Backend-Developer").index(st.session_state["position"])
        )

    st.session_state["company"] = st.selectbox(
        "Select a Company",
        ("Amazon", "Meta", "Udemy", "Tesla", "Nestle", "LinkedIn", "Spotify","Flipkart","Microsoft","Apple"),
        index=("Amazon", "Meta", "Udemy", "Tesla", "Nestle", "LinkedIn", "Spotify","Flipkart","Microsoft","Apple").index(st.session_state["company"])
    )
